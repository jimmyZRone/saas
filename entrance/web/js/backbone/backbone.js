define('backbone/backbone',['underscore', 'jquery'],function(require, exports, moudles){
...
(function() {
	...
	f.extend(s.prototype, h, {
		...
		update: function(a, b) {
			...
			d = 0;
			for (e = a.length; d < e; d++) c = a[d], g = this.get(c), b.remove && g && (l[g.cid] = !0), (b.add && !g || b.merge && g) && h.push(c);
			if (b.remove) {
				d = 0;
	...
	f.extend(m.prototype, h, {
		...
		start: function(a) {
			...
			this._wantsPushState && (this._hasPushState && b && a.hash) && (this.fragment = this.getHash().replace(z, ""), this.history.replaceState({}, document.title, this.root + this.fragment + a.search));
